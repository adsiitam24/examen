package a.b.c.d.e.f;
 /**
         * Esta clase tiene como objetivo crear nodos con datos y dirección 
         * Igualmente cuenta con dos metodos prn y gus    
         */
 /**
...
public class solu {
    class Node {
        ...
        /**
         *Esta clase le quita al nodo su vecino siguiente pero crea otro nuevo que apunte hacia el mismo
    /**
